...
xdg_menu = require("applicationsmenu")
vicious = require("vicious")

naughty.config.defaults.position         = "bottom_right"
naughty.config.defaults.margin           = 0
naughty.config.defaults.border_width     = 5
naughty.config.presets.border_color     = beautiful.border_focus or '#00ff00'

local launchbar = require("launchbar")
local mylaunchbar = launchbar("/home/eddie/.config/awesome/launchbar/")
...
local awesompd = require('awesompd/awesompd')
   ...
   musicwidget.font = "Tamsyn Bold 12" -- Set widget font
   ...
   musicwidget.path_to_icons = "/home/eddie/.config/awesome/awesompd/icons"
   ...
   musicwidget.mpd_config = "/home/eddie/.mpdconf"
...
beautiful.init("/home/eddie/.config/awesome/themes/default/theme.lua")
--   beautiful.init("/usr/share/awesome/themes/matrix/theme.lua")
...
-- wp_index = 1
-- wp_timeout  = 3600
-- wp_path = "/home/eddie/Pictures/Wallpapers/"
...
tags = {
  settings = {
     --{ names = { "Chats", "WWW", "Emacs", "4", "5", "6", "7", "8", "9" },
     { names = {"😸", "🕸", "🐮", "🕓", "🕔", "🕕", "🕖", "🕗", "🕘" },
      layout = { layouts[3], layouts[7], layouts[2], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1] }
    },
     -- { names = { "Games", "Browsing", "3", "4", "5", "6", "7", "8", "9" },
     { names = { "🎮", "🕷", "🎥", "🕟", "🕠", "🕡", "🕢", "🕣", "🕤" },
      layout = { layouts[11], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1] }
}}}
for s = 1, screen.count() do
...
orglendar.files = { "/home/eddie/Documents/org/calendars/calendar.org" }    -- Specify here all files you want to be parsed, separated by comma.
...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey }, "g", function() awful.util.spawn( "/home/eddie/pipes/dmenurec.sh" ) end),
    awful.key({ modkey, "Control" }, "n", awful.client.restore),
    awful.key({ modkey, "Shift"   }, "Escape", function() awful.util.spawn( "physlock" ) end),
    ...
    awful.key({ modkey }, "F12", function ()
        awful.prompt.run({ prompt = "Web search: " }, mypromptbox[mouse.screen].widget,
            function (command)
                awful.util.spawn("firefox 'http://duckduckgo.com/?q="..command.."'", false)
   ...
   -- awful.key({ }, "Print", function () awful.util.spawn("scrot -s -e 'mv $f ~/Pictures/ 2>/dev/null'") end),
    -- Menubar
...
clientbuttons = awful.util.table.join(
   ...
   awful.button({ }, 8, function(t) awful.tag.viewnext() end),
   awful.button({ }, 9, function(t) awful.tag.viewprev() end),
